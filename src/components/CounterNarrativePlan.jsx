...
const CounterNarrativePlan = () => {
    const planData = {
        title: "UAE-SUDAN COUNTER-NARRATIVE PLAN OVERVIEW", //From PDF title
...
// import React from 'react';
// import { Shield, ArrowUpRight, Clock, Target, BarChart3, Users, Mail, Phone, FileText, CheckCircle, FileBarChart, Calendar } from 'lucide-react';
...
//         recommendations: {
//             description: "The following recommendations outline a comprehensive approach to counter critical narratives about UAE's involvement in Sudan. These recommendations encompass tactical communication strategies, messaging frameworks, and a phased implementation timeline to effectively reshape the narrative landscape.",
//             actionPlan: {
//                 title: "Action Plan for Countering Critical Sudan Narratives",
//                 items: [
//                     "Establish a cross-functional crisis communications team dedicated to Sudan-related narratives",
//                     "Develop comprehensive factsheets on UAE humanitarian aid to Sudan with verifiable statistics",
//                     "Create visual evidence packages highlighting UAE's positive contributions in Sudan",
//                     "Identify and engage third-party validators to speak on UAE's behalf",
//                     "Monitor and rapidly respond to misinformation across key platforms",
//                     "Coordinate messaging with diplomatic and humanitarian channels",
//                     "Create content highlighting UAE's historical relationship with Sudan"
//                 ]
//             },
//             messagingFramework: {
//                 title: "Strategic Counter-Narrative Messaging Framework",
//                 items: [
//                     "Emphasize UAE's role as a humanitarian leader in the region",
//                     "Highlight the volume and impact of UAE aid to Sudan (over $600M)",
//                     "Contrast UAE's constructive approach with destabilizing actors",
//                     "Contextualize UAE's regional policy within broader security objectives",
//                     "Present evidence-based rebuttals to specific allegations",
//                     "Position UAE as an advocate for regional stability and peace",
//                     "Frame UAE actions as aligned with international community goals"
//                 ]
//             },
//             timeline: {
//                 title: "Timeline",
...
//                         timeframe: "Weeks 1-2",
//                         actions: "Deploy rapid response team, issue initial statements, activate diplomatic channels"
//                     },
//                     {
//                         name: "Narrative Establishment",
//                         timeframe: "Weeks 3-4",
//                         actions: "Roll out coordinated messaging, engage third-party validators, launch social media campaign"
//                     },
//                     {
//                         name: "Message Reinforcement",
//                         timeframe: "Months 2-3",
//                         actions: "Publish in-depth analyses, place opinion articles, host media briefings, release visual evidence"
//                     },
//                     {
//                         name: "Long-term Strategy",
//                         timeframe: "Months 4+",
//                         actions: "Maintain consistent messaging, pivot to showcasing outcomes, integrate into broader diplomacy"
//                     }
//                 ]
//             }
//         },
...
//                     </div>
//                     <p className="text-gray-700 mb-6">{planData.recommendations.description}</p>
                    
//                     {/* Action Plan subsection */}
//                     <div className="mb-6">
//                         <h3 className="text-lg font-bold text-gray-800 mb-3 flex items-center">
//                             <Target className="h-5 w-5 text-green-600 mr-2" />
//                             {planData.recommendations.actionPlan.title}
//                         </h3>
//                         <div className="bg-green-50 p-4 rounded-lg">
//                             <ul className="space-y-2">
//                                 {planData.recommendations.actionPlan.items.map((item, idx) => (
//                                     <li key={idx} className="flex items-start">
//                                         <div className="bg-green-100 text-green-800 rounded-full h-5 w-5 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5 mr-3">
//                                             {idx + 1}
//                                         </div>
...
//                     {/* Messaging Framework subsection */}
//                     <div className="mb-6">
//                         <h3 className="text-lg font-bold text-gray-800 mb-3 flex items-center">
//                             <FileBarChart className="h-5 w-5 text-green-600 mr-2" />
//                             {planData.recommendations.messagingFramework.title}
//                         </h3>
//                         <div className="bg-green-50 p-4 rounded-lg">
//                             <ul className="space-y-2">
//                                 {planData.recommendations.messagingFramework.items.map((item, idx) => (
//                                     <li key={idx} className="flex items-start">
//                                         <div className="bg-green-100 text-green-800 rounded-full h-5 w-5 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5 mr-3">
//                                             ✓
//                                         </div>
...
//                             {planData.recommendations.timeline.title}
//                         </h3>
//                         <div className="overflow-x-auto">
//                             <table className="min-w-full bg-white border border-gray-200">
//                                 <thead>
//                                     <tr className="bg-green-50">
//                                         <th className="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Phase</th>
//                                         <th className="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Timeframe</th>
//                                         <th className="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Actions</th>
//                                     </tr>
//                                 </thead>
//                                 <tbody className="divide-y divide-gray-200">
//                                     {planData.recommendations.timeline.phases.map((phase, idx) => (
//                                         <tr key={idx} className={idx % 2 === 0 ? "bg-white" : "bg-gray-50"}>
//                                             <td className="py-4 px-6 text-sm font-medium text-gray-900">{phase.name}</td>
//                                             <td className="py-4 px-6 text-sm text-gray-700">{phase.timeframe}</td>
//                                             <td className="py-4 px-6 text-sm text-gray-700">{phase.actions}</td>
//                                         </tr>
//                                     ))}
//                                 </tbody>
//                             </table>
